        ...
        <div className="space-y-4 max-h-96 overflow-y-auto pr-1">
          ...
          <div>
            ...
            <div className="space-y-1">
              {[
                { id: 'briefing', label: 'Executive Briefing & Tour', icon: FileText },
                { id: 'metrics', label: 'Telemetry & Metrics Dashboard', icon: BarChart3 },
                { id: 'rag-engine', label: 'Retrieval & AI Search Engine', icon: Search },
                { id: 'agentic-workflows', label: 'Agentic Workflows & Multi-Agent Parallelism', icon: Workflow },
